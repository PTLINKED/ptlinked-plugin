...
├── jquery-ptlinked_plugin.1.0.0.js        
└── jquery-ptlinked_plugin.1.0.0.min.js    (compressed)
```
...
<script src="/path/to/jquery-ptlinked.1.0.0.js"></script><!-- jQuery PTLINKED Plugin is required -->
<link  href="/path/to/ptlinked_plugin.css" rel="stylesheet"><!-- Plugin default stylesheet is required -->
```

The [cdnjs](https://github.com/cdnjs/cdnjs) provides CDN support for PTLINKED Plugin CSS and JavaScript. You can find the links [here](https://cdnjs.com/libraries/ptlinked_plugin).
...
- Type: `string`
- Default: `'https://api-v1.ptlinked.com'`
