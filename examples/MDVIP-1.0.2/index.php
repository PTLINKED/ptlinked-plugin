...
<head>
	...
	<link rel="stylesheet" href="../../src/v1.0.2/ptlinked_plugin.css?d=<?= __LIBRARY_LAST_CHANGE__ ;?>" crossorigin="anonymous">
	<!-- ================== END BASE CSS STYLE ================== -->
</head>
<body>
...
<!-- ================== BEGIN BASE JS ================== -->
	...
	<script src="../../src/v1.0.2//jquery-ptlinked_plugin.js?d=<?= __LIBRARY_LAST_CHANGE__ ;?>" crossorigin="anonymous"></script>
	<!-- TEST JS -->
